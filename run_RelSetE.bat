...
set ENCODER_NAME=RelSetE
set DECODER_NAME=Score
...
for %%D in (FB15k-237 Nell-995 Nell-1115) do (
    set DATA_NAME=%%D
    for %%N in (15 31 63 127) do (
        set NEG_SAMPLE_SIZE=%%N

        if /I "!DECODER_NAME!"=="Score" (
            set LOG_FILE=Logs\!DATA_NAME!_!ENCODER_NAME!_!DECODER_NAME!_NegSample_!NEG_SAMPLE_SIZE!_!JOB_ID!.log
        ) else (
            set LOG_FILE=Logs\!DATA_NAME!_!ENCODER_NAME!_!DECODER_NAME!_!JOB_ID!.log
        )
